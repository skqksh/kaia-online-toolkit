      ...
      <Card>
        <CardHeader>
          ...
          <Text>
            ...
            standard if you want to use ERC-20 for the Kaia. However, there are
            some differences between KIP-7 and ERC-20; More optional functions
            are included like mint, burn and pause extensions. You can find more
            information{' '}
            <LinkA link="https://kips.kaia.io/KIPs/kip-7">here</LinkA>. After
            successful deployment, you can find contract account in the block
            explorer.
          </Text>
          <PrivateKeyWarning />
        </CardHeader>
