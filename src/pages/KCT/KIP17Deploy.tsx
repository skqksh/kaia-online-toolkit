      ...
      <Card>
        <CardHeader>
          ...
          <Text>
            ...
            basic functionality to transfer NFTs on the Kaia network. KIP-17 is
            derived from ERC-721. But, there are some differences between KIP-17
            and ERC-721; More optional extensions are defined, like minting with
            URI, burning, and pausing extensions. You can find more information{' '}
            <LinkA link="https://kips.kaia.io/KIPs/kip-17">here</LinkA>. After
            successful deployment, you can find a contract account in the block
            explorer.
          </Text>
          <PrivateKeyWarning />
        </CardHeader>
